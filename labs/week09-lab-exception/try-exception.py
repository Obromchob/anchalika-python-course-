...
try:
    ...
    print(f"ปีหน้าคุณจะอายุ{"age + 1"} XU")
except ValueError:
    print("กรุณากรอกอายุเป็นตัวเลยจำนวนเต็ม เช่น 20")
...
เมื่อข้อมูลหรือสถานการณ์ไม่เป็นไปตาม
# แม้คำสั้งนั้นจะไม่ผิดไวยากรณ์และ Python ยังทำงานต่อได้ตามปกติ
